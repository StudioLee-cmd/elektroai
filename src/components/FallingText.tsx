...
const FallingText = () => {
    ...
    useEffect(() => {
        ...
        // ⚡ matter-js komt pas binnen als de sectie ÉCHT in beeld is (25-07,
        //    niche-homepage-395kb-js-blokkeert-lcp). De IntersectionObserver hierboven stond er al,
        //    maar gatede alleen het STARTEN van de engine: `import Matter from "matter-js"` stond
        //    top-level en werd dus onvoorwaardelijk in de homepage-chunk gebakken (~28 KB) — ook
        //    voor iedere bezoeker die nooit tot onderaan scrolt.
        let opruimen: (() => void) | null = null;
        let afgebroken = false;

        import("matter-js").then(({ default: Matter }) => {
            if (afgebroken || !containerRef.current || !canvasRef.current) return;
            ...
            const allWords = [
                ...
                // ELEKTRICIEN PUNS & FUN
                "Minder draden, meer verdienen ⚡",
                "Tijd voor koffie & je multimeter ☕",
                "Laat de telefoon maar rinkelen (AI pakt op) 📞",
                "Laat de AI je planning doen 🤖",
                "Installeren, niet telefoneren 🔌",
                "Geen kortsluiting in je planning 📅",
                "Spanning genoeg, AI regelt de rest ⚡",
                "Jij de stroom, AI het gedoe 🤖",
                "Van elektricien naar top-ondernemer 🚀",
                "Geschrokken van de rekening? AI helpt 😬",
                "Meer klussen in minder tijd ⏳",
                "Altijd onder spanning, maar rustig 🧘",
                "Strakke bedrading, strakke planning ⚡",

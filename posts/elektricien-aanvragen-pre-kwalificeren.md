...
**De klus past eigenlijk niet bij jouw expertise of werkgebied.** Je staat in Almere, de klant belt uit Diemen, en pas als je daar bent zie je dat het om een complexe bedrijfsinstallatie gaat die je eigenlijk niet doet. Tijd weg, niets gewonnen.

Al deze redenen zijn vóór je in de bus stapt te voorspellen, als je de juiste intake doet. Pre-kwalificatie is het filter dat deze situaties eruit haalt voordat je rijdt.

## Welke informatie je minimaal vooraf nodig hebt
...
- **Of ze al andere elektriciens hebben gecontact.** Eerlijk antwoord geeft je context. Meestal zijn dit de serieuze klussen waar je wél tijd in wilt investeren.

Deze vijf of zes datapunten verzamel je niet per telefoon — dat is te veel gedoe voor klant en jou. Je verzamelt ze via een [AI chatbot op je website](/chatbot) die de flow automatisch uitvraagt en de antwoorden op WhatsApp bij jou aflevert.
...
- **Laadpaal-installatie:** foto van meterkast, foto van gevel waar laadpaal komt, foto van doorvoerpad. Dat is genoeg voor een reële bandbreedte-offerte.
- **Groepenkast vervangen:** foto van huidige kast (open), foto van meterkast, schatting huidige vermogen. Genoeg voor uiteenzetting wat het kost.
- **Extra wandcontactdozen:** foto van bestaande wandstructuur en plint, locatie waar nieuwe doos komt, aangrenzende voorzieningen. Genoeg om te beslissen of het een aflopend eenvoudige klus is of een complexere infrastructuur-verbouwing.

Voor bezichtigingen die nog wél nodig zijn (complexe bedrijfsinstallaties, ingrijpende renovaties, veiligheids-gerelateerd werk) heb je dan al de basis-info en kun je de bezichtiging efficiënt doen in 20 minuten in plaats van een uur.

## De vier manieren waarop deze flow extra omzet oplevert
...
**Betere planning: werkweken worden voorspelbaarder.** Met pre-kwalificatie weet je op maandag al ruwweg welke offertes deze week converteren, omdat je de kwaliteit van aanvragen kunt inschatten voor je rijdt.
...
- **Week 1:** maak je top 10 meest voorkomende klustypes met vaste intake-vragen per klus
- **Week 2:** installeer chatbot met foto-upload-intake en WhatsApp-notificatie voor jezelf
- **Week 3:** live op website, monitor eerste 30 aanvragen, bijstellen waar nodig

Wil je de volledige pre-kwalificatie-flow opgezet krijgen voor jouw elektricienspraktijk, inclusief chatbot, foto-upload, integratie en begeleiding in de eerste maand? Doe onze [gratis AI-scan](/gratis-scan) om te zien hoeveel uur per week je nu verliest aan onrendabele offertebezoeken. Binnen vijf minuten krijg je een inschatting, en je zit nergens aan vast.
